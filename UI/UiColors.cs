...
{
    // --- 共通トークン ---
    public static Color PrimaryFore { get; set; } = Color.FromArgb(255, 235, 235, 235);
    public static Color MutedFore { get; set; } = Color.FromArgb(255, 150, 150, 150);
    public static Color AccentCyan { get; set; } = Color.FromArgb(255, 0, 245, 255);
    public static Color SurfaceBack { get; set; } = Color.FromArgb(255, 30, 30, 30);
    public static Color ChromeBack { get; set; } = Color.FromArgb(255, 26, 27, 38);
    public static Color ChromeBorder { get; set; } = Color.FromArgb(255, 55, 55, 58);
    public static Color ChromeMid { get; set; } = Color.FromArgb(255, 72, 72, 72);
    public static Color ChromeDim { get; set; } = Color.FromArgb(255, 91, 91, 91);
    ...
    // --- 波形ビュー（画面上部） ---
    public static Color WaveformBack { get; set; } = Color.FromArgb(255, 38, 38, 38);
    public static Color EmptyHint { get; set; } = Color.FromArgb(255, 140, 140, 140);
    public static Color BarNumberBg => ChromeMid;
    public static Color TempoBg { get; set; } = Color.FromArgb(255, 53, 55, 70);
    public static Color SignatureBg { get; set; } = Color.FromArgb(255, 44, 46, 58);
    public static Color MarkerRowBg { get; set; } = Color.FromArgb(255, 43, 43, 45);
    ...
    public static Color WaveFill { get; set; } = Color.FromArgb(255, 182, 182, 182);
    /// <summary>波形 0dB（垂直中心）の薄い水平線。初期値は小節線と同じ。</summary>
    public static Color WaveZeroDbLine { get; set; } = Color.FromArgb(90, 204, 204, 204);
    public static Color WaveformSourceMeterTrack { get; set; } = Color.FromArgb(255, 18, 18, 18);
    public static Color WaveformSourceMeterMinimum { get; set; } = Color.FromArgb(255, 47, 23, 0);
    public static Color WaveformSourceMeterMaximum { get; set; } = Color.FromArgb(255, 255, 128, 0);
    ...
    public static Color RegionBoundaryMarker { get; set; } = Color.FromArgb(255, 195, 195, 195);
    ...
    public static Color MusicSegmentLaneBg { get; set; } = Color.FromArgb(255, 44, 46, 58);
    public static Color MusicPlaylistLaneBg { get; set; } = Color.FromArgb(255, 53, 55, 70);
    ...
    public static Color SeekAnacrusis { get; set; } = Color.FromArgb(255, 80, 220, 110);
    public static Color SeekFadeOut { get; set; } = Colors.White;
    public static Color MouseGuide { get; set; } = Color.FromArgb(220, 255, 255, 255);
    public static Color WaveformScrollTrack { get; set; } = Color.FromArgb(255, 18, 18, 18);
    ...
    public static Color TransportBadgeBack { get; set; } = Color.FromArgb(255, 38, 38, 38);

    // --- ログ ---
    public static Color LogBack => SurfaceBack;
    public static Color LogDefault { get; set; } = Color.FromArgb(255, 220, 220, 220);
    public static Color LogHeader { get; set; } = Color.FromArgb(255, 110, 180, 255);
    public static Color LogWarning { get; set; } = Color.FromArgb(255, 255, 180, 70);
    public static Color LogError { get; set; } = Color.FromArgb(255, 255, 110, 110);
    ...
    public static Color OptionGlyphCheckMark { get; set; } = Color.FromArgb(255, 26, 27, 38);
    ...
    public static Color SectionHeaderBack { get; set; } = Color.FromArgb(255, 45, 45, 48);
    ...
    public static Color PlaylistAutoBack { get; set; } = Color.FromArgb(255, 35, 52, 75);
    public static Color PlaylistManualBack { get; set; } = Color.FromArgb(255, 65, 64, 33);
    public static Color PlaylistHoverBorder => PrimaryFore;
    public static Color PlaylistTransitionBorder => AccentCyan;
    public static Color PlaylistManualBorder { get; set; } = Color.FromArgb(255, 255, 255, 0);
    public static Color MarkerCommentErrorFore { get; set; } = Color.FromArgb(255, 255, 110, 110);
    ...
    [
        Color.FromArgb(255, 255, 179, 40),   // vivid orange
        Color.FromArgb(255, 0, 127, 255),    // strong blue
        Color.FromArgb(255, 255, 255, 50),   // vivid yellow
        Color.FromArgb(255, 160, 60, 200),   // strong purple
        Color.FromArgb(255, 255, 80, 80),    // vivid red
        Color.FromArgb(255, 0, 180, 120),    // vivid green
        Color.FromArgb(255, 255, 140, 200),  // strong pink
        Color.FromArgb(255, 100, 210, 255),  // light blue
        Color.FromArgb(255, 200, 160, 60),   // olive/gold
        Color.FromArgb(255, 120, 80, 40),    // brown
        Color.FromArgb(255, 0, 220, 220),    // cyan
        Color.FromArgb(255, 180, 220, 80),   // yellow-green
        Color.FromArgb(255, 220, 100, 40),   // orange-red
        Color.FromArgb(255, 80, 80, 220),    // blue-purple
        Color.FromArgb(255, 255, 200, 120),  // light orange
        Color.FromArgb(255, 40, 140, 80),    // dark green
        Color.FromArgb(255, 220, 60, 140),   // magenta
        Color.FromArgb(255, 140, 200, 180),  // seafoam
        Color.FromArgb(255, 255, 120, 160),  // salmon pink
        Color.FromArgb(255, 90, 90, 90),     // medium gray
    ];
    ...
    public static Color ActionLinkFore { get; set; } = Color.FromArgb(255, 110, 180, 255);
    public static Color ActionLinkHoverFore => AccentCyan;
    public static Color ActionButtonInnerBack => ChromeBack;
    public static Color ReloadButtonFill { get; set; } = Color.FromArgb(255, 45, 33, 19);
    public static Color ReloadButtonHoverFill { get; set; } = Color.FromArgb(255, 82, 55, 26);
    public static Color ReloadButtonBack { get; set; } = Color.FromArgb(255, 217, 130, 43);
    public static Color ReloadButtonFore => PrimaryFore;
    public static Color ReloadButtonHoverBack { get; set; } = Color.FromArgb(255, 245, 158, 66);
    public static Color ReloadButtonPressedBack { get; set; } = Color.FromArgb(255, 184, 106, 31);
    public static Color ClearButtonFill { get; set; } = Color.FromArgb(255, 47, 20, 20);
    public static Color ClearButtonHoverFill { get; set; } = Color.FromArgb(255, 82, 35, 35);
    public static Color ClearButtonBack { get; set; } = Color.FromArgb(255, 190, 50, 50);
    public static Color ClearButtonFore => PrimaryFore;
    public static Color ClearButtonHoverBack { get; set; } = Color.FromArgb(255, 220, 70, 70);
    public static Color ClearButtonPressedBack { get; set; } = Color.FromArgb(255, 150, 40, 40);
    public static Color ExportButtonFill { get; set; } = Color.FromArgb(255, 15, 27, 45);
    public static Color ExportButtonHoverFill { get; set; } = Color.FromArgb(255, 18, 40, 67);
    public static Color ExportButtonBack { get; set; } = Color.FromArgb(255, 30, 110, 210);
    public static Color ExportButtonFore => PrimaryFore;
    public static Color ExportButtonHoverBack { get; set; } = Color.FromArgb(255, 45, 130, 230);
    public static Color ExportButtonPressedBack { get; set; } = Color.FromArgb(255, 20, 90, 180);
    ...
    public static Color SpectrumBar { get; set; } = Color.FromArgb(255, 26, 121, 157);
    public static Color ActionButtonDisabledBorder => ChromeMid;
    public static Color ActionButtonDisabledFore => MutedFore;

    // --- WAAPI ステータスバー ---
    public static Color StatusBarBack { get; set; } = Color.FromArgb(255, 22, 22, 24);
    ...
    public static Color StatusBarConnectedBadgeBack { get; set; } = Color.FromArgb(255, 0, 107, 215);
    /// <summary>切断バッジ（DISCONNECT）の背景。</summary>
    public static Color StatusBarDisconnectedBadgeBack { get; set; } = Color.FromArgb(255, 190, 50, 50);
    /// <summary>切断時詳細・ターゲット未選択など、ステータス詳細のエラー文字。</summary>
    public static Color StatusBarErrorDetailFore { get; set; } = Color.FromArgb(255, 255, 110, 110);
    public static Color KeepTargetLockFore { get; set; } = Color.FromArgb(255, 255, 220, 48);
    public static Color KeepTargetLockHoverFore { get; set; } = Color.FromArgb(255, 255, 240, 140);
    public static Color KeepTargetUnlockFore { get; set; } = Color.FromArgb(255, 235, 235, 235);
    public static Color KeepTargetUnlockHoverFore { get; set; } = Color.FromArgb(255, 255, 255, 255);

    // --- ダイアログ／色設定パネル ---
    /// <summary>タイトルバー（DWM キャプション）背景。従来どおり #1E2026。</summary>
    public static Color TitleBarBack { get; set; } = Color.FromArgb(255, 0x1E, 0x20, 0x26);

    public static Color DialogBodyBack { get; set; } = Color.FromArgb(255, 40, 40, 42);
    public static Color DialogInputBack { get; set; } = Color.FromArgb(255, 28, 28, 30);
    public static Color DialogFore => PrimaryFore;
    public static Color DialogShadow { get; set; } = Colors.Black;
    public static Color ColorPanelBack { get; set; } = Color.FromArgb(255, 40, 40, 42);
    public static Color ColorPanelListBack { get; set; } = Color.FromArgb(255, 32, 32, 34);
    public static Color ColorPanelInputBack { get; set; } = Color.FromArgb(255, 28, 28, 30);
    ...
    [
        ...
        new("TitleBarBack", () => TitleBarBack, c => TitleBarBack = c),
    ...
    public static void Save()
    {
        ...
        foreach (var entry in Entries)
        {
            ...
            var normalized = Color.FromArgb((byte)alpha, color.R, color.G, color.B);
    ...
    /// <summary>不透明背景用（アルファを 255 に揃える）。</summary>
