...
internal sealed partial class WaveformView : System.Windows.FrameworkElement
{
    ...
    /// <summary>
    /// Tab 順のみ。WinForms の TabStop 相当。
    /// Focusable と直結すると XML 読み込み後にフォーカス不能になり、
    /// ログへフォーカスが残ったままショートカットが復帰しなくなる。
    /// </summary>
    private bool TabStop
    {
        get => System.Windows.Input.KeyboardNavigation.GetIsTabStop(this);
        set => System.Windows.Input.KeyboardNavigation.SetIsTabStop(this, value);
    }
